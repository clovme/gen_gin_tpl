...
func newUser(db *gorm.DB, opts ...gen.DOOption) user {
	...
	_user.userDo.UseModel(&do_user.User{})
...
func (u userDo) Create(values ...*do_user.User) error {
	if len(values) == 0 {
		return nil
	}
...
func (u userDo) CreateInBatches(values []*do_user.User, batchSize int) error {
	return u.DO.CreateInBatches(values, batchSize)
}

// Save : !!! underlying implementation is different with GORM
// The method is equivalent to executing the statement: db.Clauses(clause.OnConflict{UpdateAll: true}).Create(values)
func (u userDo) Save(values ...*do_user.User) error {
	if len(values) == 0 {
		return nil
	}
...
func (u userDo) First() (*do_user.User, error) {
	if result, err := u.DO.First(); err != nil {
		return nil, err
	} else {
		return result.(*do_user.User), nil
	}
}

func (u userDo) Take() (*do_user.User, error) {
...
func (u userDo) Last() (*do_user.User, error) {
...
func (u userDo) Find() ([]*do_user.User, error) {
	result, err := u.DO.Find()
	return result.([]*do_user.User), err
}

func (u userDo) FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*do_user.User, err error) {
	buf := make([]*do_user.User, 0, batchSize)
...
func (u userDo) FindInBatches(result *[]*do_user.User, batchSize int, fc func(tx gen.Dao, batch int) error) error {
...
func (u userDo) FirstOrInit() (*do_user.User, error) {
...
func (u userDo) FirstOrCreate() (*do_user.User, error) {
...
func (u userDo) FindByPage(offset int, limit int) (result []*do_user.User, count int64, err error) {
...
func (u userDo) Delete(models ...*do_user.User) (result gen.ResultInfo, err error) {
