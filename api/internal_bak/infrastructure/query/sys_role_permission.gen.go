...
func newRolePermission(db *gorm.DB, opts ...gen.DOOption) rolePermission {
	...
	_rolePermission.rolePermissionDo.UseModel(&do_role_permission.RolePermission{})
...
func (r rolePermissionDo) Create(values ...*do_role_permission.RolePermission) error {
	if len(values) == 0 {
		return nil
	}
...
func (r rolePermissionDo) CreateInBatches(values []*do_role_permission.RolePermission, batchSize int) error {
	return r.DO.CreateInBatches(values, batchSize)
}

// Save : !!! underlying implementation is different with GORM
// The method is equivalent to executing the statement: db.Clauses(clause.OnConflict{UpdateAll: true}).Create(values)
func (r rolePermissionDo) Save(values ...*do_role_permission.RolePermission) error {
	if len(values) == 0 {
		return nil
	}
...
func (r rolePermissionDo) First() (*do_role_permission.RolePermission, error) {
	if result, err := r.DO.First(); err != nil {
		return nil, err
	} else {
		return result.(*do_role_permission.RolePermission), nil
	}
}

func (r rolePermissionDo) Take() (*do_role_permission.RolePermission, error) {
...
func (r rolePermissionDo) Last() (*do_role_permission.RolePermission, error) {
...
func (r rolePermissionDo) Find() ([]*do_role_permission.RolePermission, error) {
	result, err := r.DO.Find()
	return result.([]*do_role_permission.RolePermission), err
}

func (r rolePermissionDo) FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*do_role_permission.RolePermission, err error) {
	buf := make([]*do_role_permission.RolePermission, 0, batchSize)
...
func (r rolePermissionDo) FindInBatches(result *[]*do_role_permission.RolePermission, batchSize int, fc func(tx gen.Dao, batch int) error) error {
...
func (r rolePermissionDo) FirstOrInit() (*do_role_permission.RolePermission, error) {
...
func (r rolePermissionDo) FirstOrCreate() (*do_role_permission.RolePermission, error) {
...
func (r rolePermissionDo) FindByPage(offset int, limit int) (result []*do_role_permission.RolePermission, count int64, err error) {
...
func (r rolePermissionDo) Delete(models ...*do_role_permission.RolePermission) (result gen.ResultInfo, err error) {
