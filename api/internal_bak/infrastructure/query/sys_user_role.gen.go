...
func newUserRole(db *gorm.DB, opts ...gen.DOOption) userRole {
	...
	_userRole.userRoleDo.UseModel(&do_user_role.UserRole{})
...
func (u userRoleDo) Create(values ...*do_user_role.UserRole) error {
	if len(values) == 0 {
		return nil
	}
...
func (u userRoleDo) CreateInBatches(values []*do_user_role.UserRole, batchSize int) error {
	return u.DO.CreateInBatches(values, batchSize)
}

// Save : !!! underlying implementation is different with GORM
// The method is equivalent to executing the statement: db.Clauses(clause.OnConflict{UpdateAll: true}).Create(values)
func (u userRoleDo) Save(values ...*do_user_role.UserRole) error {
	if len(values) == 0 {
		return nil
	}
...
func (u userRoleDo) First() (*do_user_role.UserRole, error) {
	if result, err := u.DO.First(); err != nil {
		return nil, err
	} else {
		return result.(*do_user_role.UserRole), nil
	}
}

func (u userRoleDo) Take() (*do_user_role.UserRole, error) {
...
func (u userRoleDo) Last() (*do_user_role.UserRole, error) {
...
func (u userRoleDo) Find() ([]*do_user_role.UserRole, error) {
	result, err := u.DO.Find()
	return result.([]*do_user_role.UserRole), err
}

func (u userRoleDo) FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*do_user_role.UserRole, err error) {
	buf := make([]*do_user_role.UserRole, 0, batchSize)
...
func (u userRoleDo) FindInBatches(result *[]*do_user_role.UserRole, batchSize int, fc func(tx gen.Dao, batch int) error) error {
...
func (u userRoleDo) FirstOrInit() (*do_user_role.UserRole, error) {
...
func (u userRoleDo) FirstOrCreate() (*do_user_role.UserRole, error) {
...
func (u userRoleDo) FindByPage(offset int, limit int) (result []*do_user_role.UserRole, count int64, err error) {
...
func (u userRoleDo) Delete(models ...*do_user_role.UserRole) (result gen.ResultInfo, err error) {
