...
func newRoleGroup(db *gorm.DB, opts ...gen.DOOption) roleGroup {
	...
	_roleGroup.roleGroupDo.UseModel(&do_role_group.RoleGroup{})
...
func (r roleGroupDo) Create(values ...*do_role_group.RoleGroup) error {
	if len(values) == 0 {
		return nil
	}
...
func (r roleGroupDo) CreateInBatches(values []*do_role_group.RoleGroup, batchSize int) error {
	return r.DO.CreateInBatches(values, batchSize)
}

// Save : !!! underlying implementation is different with GORM
// The method is equivalent to executing the statement: db.Clauses(clause.OnConflict{UpdateAll: true}).Create(values)
func (r roleGroupDo) Save(values ...*do_role_group.RoleGroup) error {
	if len(values) == 0 {
		return nil
	}
...
func (r roleGroupDo) First() (*do_role_group.RoleGroup, error) {
	if result, err := r.DO.First(); err != nil {
		return nil, err
	} else {
		return result.(*do_role_group.RoleGroup), nil
	}
}

func (r roleGroupDo) Take() (*do_role_group.RoleGroup, error) {
...
func (r roleGroupDo) Last() (*do_role_group.RoleGroup, error) {
...
func (r roleGroupDo) Find() ([]*do_role_group.RoleGroup, error) {
	result, err := r.DO.Find()
	return result.([]*do_role_group.RoleGroup), err
}

func (r roleGroupDo) FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*do_role_group.RoleGroup, err error) {
	buf := make([]*do_role_group.RoleGroup, 0, batchSize)
...
func (r roleGroupDo) FindInBatches(result *[]*do_role_group.RoleGroup, batchSize int, fc func(tx gen.Dao, batch int) error) error {
...
func (r roleGroupDo) FirstOrInit() (*do_role_group.RoleGroup, error) {
...
func (r roleGroupDo) FirstOrCreate() (*do_role_group.RoleGroup, error) {
...
func (r roleGroupDo) FindByPage(offset int, limit int) (result []*do_role_group.RoleGroup, count int64, err error) {
...
func (r roleGroupDo) Delete(models ...*do_role_group.RoleGroup) (result gen.ResultInfo, err error) {
