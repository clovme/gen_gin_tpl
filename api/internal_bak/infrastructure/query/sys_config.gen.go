...
func newConfig(db *gorm.DB, opts ...gen.DOOption) config {
	...
	_config.configDo.UseModel(&do_config.Config{})
...
func (c configDo) Create(values ...*do_config.Config) error {
	if len(values) == 0 {
		return nil
	}
...
func (c configDo) CreateInBatches(values []*do_config.Config, batchSize int) error {
	return c.DO.CreateInBatches(values, batchSize)
}

// Save : !!! underlying implementation is different with GORM
// The method is equivalent to executing the statement: db.Clauses(clause.OnConflict{UpdateAll: true}).Create(values)
func (c configDo) Save(values ...*do_config.Config) error {
	if len(values) == 0 {
		return nil
	}
...
func (c configDo) First() (*do_config.Config, error) {
	if result, err := c.DO.First(); err != nil {
		return nil, err
	} else {
		return result.(*do_config.Config), nil
	}
}

func (c configDo) Take() (*do_config.Config, error) {
...
func (c configDo) Last() (*do_config.Config, error) {
...
func (c configDo) Find() ([]*do_config.Config, error) {
	result, err := c.DO.Find()
	return result.([]*do_config.Config), err
}

func (c configDo) FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*do_config.Config, err error) {
	buf := make([]*do_config.Config, 0, batchSize)
...
func (c configDo) FindInBatches(result *[]*do_config.Config, batchSize int, fc func(tx gen.Dao, batch int) error) error {
...
func (c configDo) FirstOrInit() (*do_config.Config, error) {
...
func (c configDo) FirstOrCreate() (*do_config.Config, error) {
...
func (c configDo) FindByPage(offset int, limit int) (result []*do_config.Config, count int64, err error) {
...
func (c configDo) Delete(models ...*do_config.Config) (result gen.ResultInfo, err error) {
