...
func newEnums(db *gorm.DB, opts ...gen.DOOption) enums {
	...
	_enums.enumsDo.UseModel(&do_enums.Enums{})
...
func (e enumsDo) Create(values ...*do_enums.Enums) error {
	if len(values) == 0 {
		return nil
	}
...
func (e enumsDo) CreateInBatches(values []*do_enums.Enums, batchSize int) error {
	return e.DO.CreateInBatches(values, batchSize)
}

// Save : !!! underlying implementation is different with GORM
// The method is equivalent to executing the statement: db.Clauses(clause.OnConflict{UpdateAll: true}).Create(values)
func (e enumsDo) Save(values ...*do_enums.Enums) error {
	if len(values) == 0 {
		return nil
	}
...
func (e enumsDo) First() (*do_enums.Enums, error) {
	if result, err := e.DO.First(); err != nil {
		return nil, err
	} else {
		return result.(*do_enums.Enums), nil
	}
}

func (e enumsDo) Take() (*do_enums.Enums, error) {
...
func (e enumsDo) Last() (*do_enums.Enums, error) {
...
func (e enumsDo) Find() ([]*do_enums.Enums, error) {
	result, err := e.DO.Find()
	return result.([]*do_enums.Enums), err
}

func (e enumsDo) FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*do_enums.Enums, err error) {
	buf := make([]*do_enums.Enums, 0, batchSize)
...
func (e enumsDo) FindInBatches(result *[]*do_enums.Enums, batchSize int, fc func(tx gen.Dao, batch int) error) error {
...
func (e enumsDo) FirstOrInit() (*do_enums.Enums, error) {
...
func (e enumsDo) FirstOrCreate() (*do_enums.Enums, error) {
...
func (e enumsDo) FindByPage(offset int, limit int) (result []*do_enums.Enums, count int64, err error) {
...
func (e enumsDo) Delete(models ...*do_enums.Enums) (result gen.ResultInfo, err error) {
