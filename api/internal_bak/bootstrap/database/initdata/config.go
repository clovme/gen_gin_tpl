...
func (d *InitData) Config() {
	modelList := []do_config.Config{
		{Name: constants.ContextIsEncrypted, Value: em_bool.False.Key(), Default: em_bool.False.Key(), Show: em_bool.True, Description: "是否开启加密模式"},
		{Name: constants.WebTitle, Value: variable.WebTitle, Default: variable.WebTitle, Show: em_bool.True, Description: "站点标题"},
		...
		{Name: constants.Countdown, Value: "60", Default: "60", Show: em_bool.True, Description: "统一倒计时时间，单位秒"},
	}
