...
(function (global, factory) {
    ...
    function configDefaults$1() {
        ...
        return {...defaults$1, ...config};
    }

    // 响应拦截器
    function response$default(response) {
        response.use(result => {
    ...
    const axios = createInstance(configDefaults$1());

    request$default(axios.interceptors.request)
    response$default(axios.interceptors.response)
